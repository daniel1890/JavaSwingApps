...
public class Calculator extends javax.swing.JFrame {
    ...
    public void wiskundigeOperatie() 
    {
        switch(berekening) 
        {   
            // Addition
    ...
    public void disable(boolean switchOnOff) {
        isOn = switchOnOff;
        jTextField1.setEnabled(isOn);
        jButton2.setEnabled(isOn);
        jButton3.setEnabled(isOn);
        jButton4.setEnabled(isOn);
        jButton5.setEnabled(isOn);
        jButton6.setEnabled(isOn);
        jButton7.setEnabled(isOn);
        jButton8.setEnabled(isOn);
        jButton9.setEnabled(isOn);
        jButton10.setEnabled(isOn);
        jButton11.setEnabled(isOn);
        jButton12.setEnabled(isOn);
        jButton13.setEnabled(isOn);
        jButton14.setEnabled(isOn);
        jButton15.setEnabled(isOn);
        jButton16.setEnabled(isOn);
        jButton17.setEnabled(isOn);
        jButton18.setEnabled(isOn);
        jButton19.setEnabled(isOn);
    }
